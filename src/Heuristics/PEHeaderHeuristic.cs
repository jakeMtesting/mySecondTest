...
namespace AntivirusScanner.Heuristics
{
    ...
    public sealed class PEHeaderHeuristic : IHeuristic
    {
        ...
        private static readonly HashSet<string> SuspiciousSectionNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            "UPX0", "UPX1", "UPX2",
            ".packed", ".pack",
            "ASPack", ".aspack",
        ...
        public void Analyze(ReadOnlySpan<byte> fileBytes, ScanResult result)
        {
            ...
            if (fileBytes[e_lfanew]     != 0x50 ||
                fileBytes[e_lfanew + 1] != 0x45 ||
            ...
            CheckFileExtensionMismatch(result, characteristics);
            ...
            int tlsDirectoryOffset = is64Bit ? optOffset + 120 : optOffset + 104;
        ...
        private void CheckFileExtensionMismatch(ScanResult result, ushort characteristics)
        {
